...
import { Calendar, Shield, Award, Play, ArrowRight, Star } from 'lucide-react';
          ...
          >
            ...
            >
              <Button 
                ...
                size="lg" 
                className="bg-gradient-to-r from-blue-600 to-teal-500 hover:from-blue-700 hover:to-teal-600 text-white px-8 py-6 text-lg shadow-xl hover:shadow-2xl transition-all duration-300"
              >
              ...
              <Button 
                variant="outline" 
                size="lg"
                className="border-2 border-slate-300 hover:border-blue-400 text-slate-700 hover:text-blue-600 px-8 py-6 text-lg bg-white/80 backdrop-blur-sm"
              >
          ...
          >
            <div className="relative">
              ...
              <div className="relative bg-white rounded-3xl shadow-2xl overflow-hidden">
                <div className="aspect-[4/5] bg-gradient-to-br from-blue-50 to-teal-50 flex items-center justify-center">
                  <img 
                    src="https://tse4.mm.bing.net/th/id/OIP.KhgvG3gC0S6J_OJakCbISgAAAA?r=0&rs=1&pid=ImgDetMain&o=7&rm=3"
